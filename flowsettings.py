...
KH_REASONINGS = [
    ...
    "ktem.reasoning.websearch.WebSearchPipeline",
    "ktem.reasoning.simple_n_websearch.FullQAWebSearchPipeline",
...
KH_VLM_ENDPOINT = "{0}/openai/deployments/{1}/chat/completions?api-version={2}".format(
    ...
    config("OPENAI_VISION_DEPLOYMENT_NAME", default="gpt-4o-mini"),
