...
from libs.kotaemon.kotaemon.agents.lats.agent import LATSAgent
...
class LATSAgentPipeline(BaseReasoning):
    ...
    def get_pipeline(
        ...
        pipeline = LATSAgentPipeline(retrievers=retrievers) 
        ...
        for tool_name in settings[f"reasoning.options.{_id}.tools"]:
            ...
            if tool_name == "SearchDoc":
                ...
                tool.llm = llm
            tools.append(tool.to_langchain_format())
        pipeline.agent.tools = tools
    ...
    def get_user_settings(cls) -> dict:
        ...
        tool_choices = ["Google", "LLM", "SearchDoc"]
    ...
    def get_info(cls) -> dict:
        return {
            ...
            "name": "LATS Agent",
            "description": (
                "Implementing LATS paradigm: https://github.com/langchain-ai/langgraph/blob/main/docs/docs/tutorials/lats/lats.ipynb. "
